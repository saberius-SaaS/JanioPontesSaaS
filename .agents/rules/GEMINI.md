...
### 📝 Artifact-First Mode (MANDATORY)

**This project operates in STRICT Artifact-First Mode.**
- **Verbosity:** 0. Keep all responses strictly minimal.
- **Explanations:** None. Do not explain the code or your reasoning unless explicitly asked.
- **Diff Only:** When modifying files, only output the necessary diffs or changes.
- **Configuration:** Always respect `.agents/config.json`.
